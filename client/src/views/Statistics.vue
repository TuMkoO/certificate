  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      certArr.forEach((cert) => {
        // uniquePerson[cert.passport] = uniquePerson[cert.passport] + 1 || 1;
        uniquePerson[
    ...
    return {
      ...
      weldingMethodChartData,
      accessesChartData,
      agesChartData,
      workYearsChartData,
      qualifyingRankChartData,
      workChartData,
      typeWorkChartData,
      yearsAttestationChartData,
      monthAttestationChartData,
      alltimeAttestationChartData,
